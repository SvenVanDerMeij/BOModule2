...
let inhoud = ["mijn vrouw moest janken van plezier, top plek", "mijn kind is in dit gebouw geboren, ik maak me mild zorgen", "Iemand werd boos op me, maar toen liep hij meteen van me weg", "Heel goed museum, maar een iets minder goed hockey veld", "Maria, ik mis de kinderen, ik wil ze terug", "Heel specifiek, prachtig, maar toch elegant, het spreekt me aan, maar toch weer niet", "mooi gebouw, jammer dat ze geen fortnite battlepass hebben", "Heel goed hockeyveld, maar een iets minder goed museum", "Ik ben blind, ik vond het geweldig", "Herman, je krijgt de kinderen niet terug, sorry", "Als dit kunst is kun je mij Van Gogh noemen", "Ik heb veel geld gewonnen in het poker spel in de kelder", "ik mocht geen schilderij meenemen ook al vroeg ik het heel aardig", "help ik zit vast op het toilet op de de derde verdieping vleugel b", "Ik ben iets minder depressief geworden hiervan, NEE NATUURLIJK NIET", "blijkbaar was dat toilet 'kunst'en werd ik uit het museum getrapt, ik had gewoon last van diaree, de avond ervoor met Anita Chinees gegeten, was wel erg lekker, Groeten henk", "Fijn dat er gratis entree is, wel jammer dat je door een raam moet klimmen en niet gezien moet worden door de cameras"]
let beweging = 0
function setup() {
